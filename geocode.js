   ...
   angular.module('natafuta', ['ionic', 'xgeolocate']);
  ...
  angular.module('xgeolocate',['uiGmapgoogle-maps'])
    .factory('appModalSvc', ReusableModal)
    .controller('geoplace', GeocodeCtrl);
  ...
  Geocoder = function($q, $ionicPlatform, appModalSvc, uiGmapGoogleMapApi) {
    ...
    self = {
      ...
      showResultsAsMap: function(address, geoCodeResults) {
        return appModalSvc.show('address.html', 'VerifyLookupCtrl as vm', {
          address: address,
